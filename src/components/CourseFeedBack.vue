...
<template>
  <section class="flex flex-col space-y-4 w-full">
    ...
    <div class="flex justify-between items-center">
      ...
      <!-- Ratings Dropdown -->
      <Menu as="div" class="relative w-1/4">
        <MenuButton
          class="flex justify-between w-full px-4 items-center gap-x-1.5 py-2 lg:py-3 text-sm lg:text-base font-semibold shadow-xl ring-1 ring-inset rounded-3xl bg-background text-font hover:bg-fourth ring-tertiary"
        >
